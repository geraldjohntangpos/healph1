        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-sm-8">
                    <div id="loginForm">
                        <h1 class="wow slideInDown">Post a Service</h1>
                        <!--            registration form    -->
                        <form class="center-block" action="../queries/postservice.php" method="post" enctype="multipart/form-data" >
                            <!--    name-->
                            <div class="form-group">
                                <input class="form-control wow lightSpeedIn" id="servicename" name="servicename" placeholder="Name of Service" type="text" required > </div>
                            ...
                            <div class="form-group">
                                <select class="form-control wow lightSpeedIn" id="type" name="type" required >
																	...
																	<option value="1">Accupuncture</option>
																	<option value="2">Hilot</option>
																</select>
														</div>
