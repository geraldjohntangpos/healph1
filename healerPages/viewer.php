<?php
	...
	if(isset($_GET['viewtype']) && isset($_GET['accountid']) && isset($_GET['viewid'])) {
		...
		if($viewtype == "service") {
			...
			$sql = "SELECT T.PRODTYPE_ID, T.PRODTYPE, P.PRODUCT_ID, P.PRODTYPE_ID, P.ACCT_ID, P.DESCRIPTION, P.RATE, P.STATUS, P.PICTURE, P.NAME, P.PRICE FROM product_type AS T INNER JOIN product AS P ON T.PRODTYPE_ID = P.PRODTYPE_ID WHERE P.ACCT_ID = '$accountid' AND P.PRODUCT_ID = '$viewid'";
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4 col-md-pull-8 col-sm-pull-8"> <img class="img-responsive wow slideInDown" src="../images/<?php echo $viewtype. "/" .$accountid. "/" .$picture; ?>" style="width: 300px; height: 300px;" />
                    ...
                    <p class="wow rotateInDownRight">Products Available: </p>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    ...
                    <ul class="wow fadeInDown">
											<iframe src="../queries/<?php echo $iframelink.$theid; ?>" style="width: 450px; height: 450px;">
