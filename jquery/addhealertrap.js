...
function checkSubmitValidity() {
	...
	if($('#usernameMessage').text()!="Username available!" || $('#passwordMessage').text()!="" || $('#firstnameMessage').text()!="" || $('#lastnameMessage').text()!="" || $('#emailaddMessage').text()!="" || $('#mobileMessage').text()!="" || $('input[name="username"]').val()=="" || $('input[name="password"]').val()=="" || $('input[name="firstname"]').val()=="" || $('input[name="lastname"]').val()=="" || $('input[name="emailadd"]').val()=="" || $('input[name="mobile"]').val()=="") {
