        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <h1 class="wow tada">Trending Now!</h1> </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4">
                    <!--                        trending healers-->
                        ...
                        <h1 class="wow rollIn">Trending Healers</h1>
                        <ul class="wow tada">
													<?php
                ...
                <div class="col-md-4 col-sm-4">
                        ...
                        <h1 class="wow rollIn">Trending Methods</h1>
                        <ul class="wow tada">
													<?php
                ...
                <div class="col-md-4 col-sm-4">
                        ...
                        <h1 class="wow rollIn">Trending Products</h1>
                        <ul class="wow tada">
													<?php
