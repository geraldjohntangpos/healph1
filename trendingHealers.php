            ...
            <div class="row">
                ...
                <div class="col-md-2 col-sm-2">
                    <div class="form-group">
                        <input class="form-control wow wobble" id="search" placeholder="Search" type="text"> </div>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <h1 class="wow swing">Trending Healers</h1> </div>
            </div>
        </div>
    </section>
